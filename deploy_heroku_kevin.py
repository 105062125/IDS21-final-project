...
def load_data():
    ...
    df_facebook_before_insurrection = pd.read_csv('https://testcsvfileapi.s3.us-east-2.amazonaws.com/testpermission/facebook_before_insurrection.csv')
    df_facebook_after_insurrection = pd.read_csv('https://testcsvfileapi.s3.us-east-2.amazonaws.com/testpermission/facebook_after_insurrection.csv')
    df_reddit_before_insurrection = pd.read_csv('https://testcsvfileapi.s3.us-east-2.amazonaws.com/testpermission/reddit_before_insurrection.csv')
    df_reddit_after_insurrection = pd.read_csv('https://testcsvfileapi.s3.us-east-2.amazonaws.com/testpermission/reddit_after_insurrection.csv')
    df_twitter_before_insurrection = pd.read_csv('https://testcsvfileapi.s3.us-east-2.amazonaws.com/testpermission/twitter_before_insurrection.csv')
    df_twitter_after_insurrection = pd.read_csv('https://testcsvfileapi.s3.us-east-2.amazonaws.com/testpermission/twitter_after_insurrection.csv')
...
def load_data2():
    ...
    df_facebook_before_election = pd.read_csv('https://testcsvfileapi.s3.us-east-2.amazonaws.com/testpermission/facebook_before_election.csv')
    df_facebook_after_election = pd.read_csv('https://testcsvfileapi.s3.us-east-2.amazonaws.com/testpermission/facebook_after_election.csv')
    df_reddit_before_election = pd.read_csv('https://testcsvfileapi.s3.us-east-2.amazonaws.com/testpermission/reddit_before_election.csv')
    df_reddit_after_election = pd.read_csv('https://testcsvfileapi.s3.us-east-2.amazonaws.com/testpermission/reddit_after_election.csv')
    df_twitter_before_election = pd.read_csv('https://testcsvfileapi.s3.us-east-2.amazonaws.com/testpermission/twitter_before_election.csv')
    df_twitter_after_election = pd.read_csv('https://testcsvfileapi.s3.us-east-2.amazonaws.com/testpermission/twitter_after_election.csv')
...
if event_selector == 'Insurrection':
    df_twitter_before_ext = pd.read_csv('https://testcsvfileapi.s3.us-east-2.amazonaws.com/testpermission/after_with_places_ext.csv')
    df_twitter_after_ext = pd.read_csv('https://testcsvfileapi.s3.us-east-2.amazonaws.com/testpermission/before_with_places_ext.csv')

elif event_selector == 'Election Fraud':
    df_twitter_before_ext = pd.read_csv('https://testcsvfileapi.s3.us-east-2.amazonaws.com/testpermission/after_with_places_ext_election.csv')
    df_twitter_after_ext = pd.read_csv('https://testcsvfileapi.s3.us-east-2.amazonaws.com/testpermission/before_with_places_ext_election.csv')
